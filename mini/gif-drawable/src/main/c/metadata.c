...
Java_com_ubtrobot_giflib_GifInfoHandle_getComment(JNIEnv *env, jclass __unused handleClass,
                                                  jlong gifInfo) {
...
Java_com_ubtrobot_giflib_GifInfoHandle_isAnimationCompleted(JNIEnv __unused *env,
...
Java_com_ubtrobot_giflib_GifInfoHandle_getLoopCount(JNIEnv __unused *env,
...
Java_com_ubtrobot_giflib_GifInfoHandle_setLoopCount(JNIEnv __unused *env,
                                                    jclass __unused handleClass, jlong gifInfo,
                                                    jchar loopCount) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info != NULL) {
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getDuration(JNIEnv *__unused  env,
                                                   jclass __unused handleClass, jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
        return 0;
...
Java_com_ubtrobot_giflib_GifInfoHandle_getSourceLength(JNIEnv __unused *env,
                                                       jclass __unused handleClass, jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
        return -1;
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getCurrentPosition(JNIEnv *__unused env,
                                                          jclass __unused handleClass,
                                                          jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getMetadataByteCount(JNIEnv *__unused  env,
                                                            jclass __unused handleClass,
                                                            jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getAllocationByteCount(JNIEnv *__unused  env,
                                                              jclass __unused handleClass,
                                                              jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getNativeErrorCode(JNIEnv *__unused  env,
                                                          jclass __unused handleClass,
                                                          jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getCurrentLoop(JNIEnv __unused *env,
                                                      jclass __unused handleClass, jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
        return 0;
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getCurrentFrameIndex(JNIEnv __unused *env,
                                                            jclass __unused handleClass,
                                                            jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
...
Java_com_ubtrobot_giflib_GifInfoHandle_getSavedState(JNIEnv *env, jclass __unused handleClass,
                                                     jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    if (info == NULL) {
        return NULL;
    ...
    jlong nativeState[4] = {(jlong) info->currentIndex, (jlong) info->currentLoop,
                            info->lastFrameRemainder};
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_restoreSavedState(JNIEnv *env, jclass __unused handleClass,
                                                         jlong gifInfo, jlongArray state,
                                                         jobject jbitmap) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
    void *pixels;
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getFrameDuration(__unused JNIEnv *env,
                                                        jclass __unused handleClass, jlong gifInfo,
                                                        jint index) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
...
__unused JNIEXPORT jboolean JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_isOpaque(__unused JNIEnv *env, jclass __unused handleClass,
                                                jlong gifInfo) {
    GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getWidth(__unused JNIEnv *env, jclass __unused class,
                                                jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL) {
        return 0;
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getHeight(__unused JNIEnv *env, jclass __unused class,
                                                 jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL) {
        return 0;
...
__unused JNIEXPORT jint JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_getNumberOfFrames(__unused JNIEnv *env,
