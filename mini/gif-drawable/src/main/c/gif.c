...
Java_com_ubtrobot_giflib_GifInfoHandle_openFile(JNIEnv *env, jclass __unused class,
                                                jstring jfname) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_openByteArray(JNIEnv *env, jclass __unused class,
                                                     jbyteArray bytes) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_openDirectByteBuffer(JNIEnv *env, jclass __unused class,
                                                            jobject buffer) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_openStream(JNIEnv *env, jclass __unused class,
                                                  jobject stream) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_ubtrobot_giflib_GifInfoHandle_openFd(JNIEnv *env, jclass __unused handleClass, jobject jfd,
                                              jlong offset) {
