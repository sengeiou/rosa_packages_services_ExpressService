...
/**
 * Abstract class for all input sources, to be used with {@link GifTextView}
 */
public abstract class InputSource {
  ...
  final GifDrawable build(final GifDrawable oldDrawable, final ScheduledThreadPoolExecutor executor,
    ...
    return new GifDrawable(createHandleWith(options), oldDrawable, executor,
  ...
  public static final class DirectByteBufferSource extends InputSource {
    ...
    @Override GifInfoHandle open() throws GifIOException {
  ...
  public static final class UriSource extends InputSource {
    ...
    @Override GifInfoHandle open() throws IOException {
