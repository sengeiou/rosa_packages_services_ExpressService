package com.ubtrobot.giflib.transforms;
...
/**
 * Interface to support clients performing custom transformations before the current GIF Bitmap is
 * drawn.
 */
public interface Transform {
   ...
   * In this latter case the latest {@link GifDrawable} bounds (empty {@link Rect} if they were not
   * set yet).
   *
