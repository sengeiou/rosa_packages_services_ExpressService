 ...
 * See <a href="https://medium.com/keepsafe-engineering/the-perils-of-loading-native-libraries-on-android-befa49dce2db">ReLinker</a>
 * for more details.
 */
public class LibraryLoader {
  static final String SURFACE_LIBRARY_NAME = "droidsonroids_gif_surface";
  static final String BASE_LIBRARY_NAME = "droidsonroids_gif";
  ...
  /**
   * Initializes loader with given `Context`. Subsequent calls should have no effect since
   * application Context is retrieved.
