...
public abstract class GifDrawableInit<T extends GifDrawableInit<T>> {
  ...
  /**
   * Sample size controlling subsampling, see {@link GifOptions#setInSampleSize(int)} for more
   * details.
   ...
   * Warning: value set by {@link #threadPoolSize(int)} will not be taken into account after setting
   * executor
   *
   * @param executor executor to be used or null for default (each drawable instance has its own
   * executor)
   * @return this builder instance, to chain calls
   */
   ...
   * higher.
   *
   * @param isRenderingTriggeredOnDraw whether rendering of the next frame is scheduled after
   * drawing (default)
   ...
   * take a faster drawing case than non-opaque one. See GifTextureView#setOpaque(boolean)
   * for more information.<br>
   * Currently it is used only by GifTextureView, not by {@link GifDrawable}.
   * <p>
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(InputStream)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(AssetFileDescriptor)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(FileDescriptor)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(AssetManager, String)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(ContentResolver, Uri)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(File)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(String)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(byte[])}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(ByteBuffer)}
   *
  ...
  /**
   * Wrapper of {@link com.ubtrobot.giflib.GifDrawable#GifDrawable(Resources, int)}
   *
  ...
  /**
   * Equivalent to {@link #renderingTriggeredOnDraw(boolean)}. This method does not follow naming
   * convention
