...
public class GifTextView extends TextView {
   ...
   */
  @RequiresApi(Build.VERSION_CODES.LOLLIPOP) public GifTextView(Context context, AttributeSet attrs,
  ...
  private void init(AttributeSet attrs, int defStyle, int defStyleRes) {
    if (attrs != null) {
      ...
      setBackgroundInternal(getGifOrDefaultDrawable(
          attrs.getAttributeResourceValue(GifViewUtils.ANDROID_NS, "background", 0)));
  ...
  @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR1) @Override
