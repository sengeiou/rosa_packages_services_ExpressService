...
public class PolystarShape implements ContentModel {
  ...
  @Override public void tween(ComponentType componentType, float progress) {
    points.tween(componentType, progress);
    position.tween(componentType, progress);
    rotation.tween(componentType, progress);
    innerRadius.tween(componentType, progress);
    outerRadius.tween(componentType, progress);
    innerRoundedness.tween(componentType, progress);
    outerRoundedness.tween(componentType, progress);
  }
}
