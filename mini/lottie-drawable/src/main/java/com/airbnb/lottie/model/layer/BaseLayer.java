...
public abstract class BaseLayer
  ...
  @SuppressWarnings(value = {"WrongConstant", "deprecation"}) @Override
  ...
  private void recordRenderTime(float ms) {
     final LottieComposition composition = lottieDrawable.getComposition();
     if (composition !=null) {
       //composition.getPerformanceTracker().recordRenderTime(layerModel.getName(), ms);
     }
  }
  ...
  @SuppressWarnings(value={"WrongConstant", "deprecation"}) private void applyMasks(Canvas canvas, Matrix matrix,
