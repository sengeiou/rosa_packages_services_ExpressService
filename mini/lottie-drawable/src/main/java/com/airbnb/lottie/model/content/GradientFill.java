...
public class GradientFill implements ContentModel {
  ...
  public GradientFill(String name, GradientType gradientType, Path.FillType fillType,
      ...
      AnimatablePointValue endPoint, @Nullable AnimatableFloatValue highlightLength,
      @Nullable AnimatableFloatValue highlightAngle) {
  ...
  @Override public void tween(ComponentType componentType, float progress) {
    gradientColor.tween(componentType, progress);
    opacity.tween(componentType, progress);
    startPoint.tween(componentType, progress);
    endPoint.tween(componentType, progress);
  }
}
